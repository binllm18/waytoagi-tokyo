export default {
  ...
  "s6": {
    ...
    "cat1": "FEATURED SPONSORS",
    "cat2": "FEATURED COMMUNITY PARTNERS",
    "cat3": "FEATURED MEDIA PARTNERS"
  },
  "s7": {
    "title": "The Venue",
  ...
  "s10": {
    ...
    "step": "1/5",
    "sub": "BONSAI BRANDING AND FLAGS SET",
    "desc": "Gain premium visibility throughout the heart of the venue with our Park Path Flag and Bonsai. Your brand will be prominently displayed along the garden path, ensuring high exposure as attendees explore the event's most scenic and trafficked areas.",
    "total": "Total ",
    "num": "28",
    "set": " Bonsai Set",
    "note": "1 Set = 1 Bonsai Branding + 1 Branding Flag"
  },
  "s11": {
    "title": "VENUE BRANDING",
    "step": "4/5",
    "sub": "RECEPTION PHOTO BANNER",
    "desc": "Your logo will be prominently displayed on the main banner in Section A, the designated photo area where attendees capture memorable moments throughout the event."
  },
  "s12": {
    "title": "VENUE BRANDING"
  },
  "s13": {
    "title": "MEDIA",
    "sub": "PRESS CONFERENCE IN FRONT OF 30 MEDIA PARTNERS (VIP BUILDING)",
    "desc": "You will be featured in an exclusive press conference held in the VIP building, attended by 30 media partners, providing exceptional exposure and publicity opportunities."
  },
  "s14": {
    "title": "TICKETS",
    "generalPass": "GENERAL PASS",
    "days": "1 DAYS",
    "desc": "Main Building: Exhibition, Speakers, Performance, Terrace, Tea House, Lake, Bonsai Spot, Oval, Side Events."
  },
  "s15": {
    "title": "DIGITAL BRANDING",
    "sub1": "PRESS RELEASE ARTICLE DISTRIBUTIONS (30 MEDIA) X2 TIMES",
    "desc1": "Two press release articles will be distributed to 30 specialized Japanese media outlets in IT, technology, and finance, maximizing exposure before and after the event.",
    "sub2": "ARTICLE ON TEAMZ SUMMIT WEBSITE X2 TIMES",
    "desc2": "A dedicated article will be published on the WAYTOAGI SUMMIT website in the next section, highlighting your company and its participation."
  },
  "s16": {
    "title": "OTHERS",
    "flyer": "FLYER IN WELCOME BAG",
    "flyerDesc": "Your promotional flyer will be included in the official welcome bag given to all attendees, ensuring direct exposure to every participant from the moment they arrive.",
    "pamphlet": "COMPANY INFO ON PAMPHLET",
    "pamphletDesc": "Your company logo and profile will be featured in the official Summit pamphlet, providing attendees with essential information about your brand and offerings."
  },
  "s17": {
